...
if __name__ == "__main__":
    ...
    for f in os.listdir():
        ...
        print(new,'The count is: ',count)
        #result.append(result)
        i = i + 1
    print('time taken :',time.time() - start)
    #print(result)
    """
    name1 = str(input('Enter the name of the image: '))
    name = './input_images/'+name1
    pred,img=main(name)
    #os.chdir('..')
    #licensePlatePath = name.split('.')[0]+'.jpg'
    licensePlatePath = './licensePlatePath/' + name1
    try:
    ...
    os.system("python check_ocr.py "+name1)
