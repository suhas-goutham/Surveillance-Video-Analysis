...
input_video2 = "./try/pradarshana2.mp4"

detection_graph, category_index = backbone.set_model('ssd_mobilenet_v1_coco_2017_11_17')

vcap = cv2.VideoCapture('./try/pradarshana2.mp4') 
...
msg1="Lane 1 has "+str(count1)+" vehicles at time "+str(time1)+". Lane 2 has "+str(count2)+" vehicles at time "+str(time2)+"."
