...
input_video2 = "./people/cropped12.mp4"

detection_graph, category_index = backbone.set_model('ssd_mobilenet_v1_coco_2017_11_17')

vcap = cv2.VideoCapture("./people/cropped12.mp4") 
...
output_video='./output_videos/app_output/people/output4.avi'
...
msg3="Total number of people inside the building at time "+time2+" is "+str(count)+" people."
msg=msg1+msg2+msg3
