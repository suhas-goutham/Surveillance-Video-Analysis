...
def cumulative_object_counting_x_axis(output_video,input_video, detection_graph, category_index, is_color_recognition_enabled, fps, width, height, roi, deviation):
...
def cumulative_object_counting_y_axis(output_video,input_video, detection_graph, category_index, is_color_recognition_enabled, fps, width, height, roi, deviation):
        total_passed_vehicle = 0        
